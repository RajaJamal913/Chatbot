        ...
        {mode === "search" ? (
          ...
          <div className="space-y-4">
            {messages.map((msg, idx) => (
              ...
              >
                <p
                  className={`inline-block max-w-[70%] rounded-lg px-4 py-2 shadow user-chat ${
                    msg.role === "user"
            ...
            {isTyping && (
              <div className="text-left text-gray-500">
                <p className="inline-block max-w-[70%] rounded-lg bg-blue-50 px-4 py-2 shadow animate-pulse bot-chat ">
                  Typing...
                </p>
              </div>
            )}
